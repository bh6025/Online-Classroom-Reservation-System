											...
											<div class="modal-dialog" role="document">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="modal-footer">
															<button type="button" class="btn btn-default"
																data-dismiss="modal" type="submit" onclick="reject()">확인</button>
														</div>
													...
													function reject(){
														...
														query += "&adminReason=";
														//query += adminReason;
														query += encodeURIComponent(adminReason);
														//location.href="rejectReservation?userID=userID&buildingName=buildingName&classRoomName=classRoomName&reservationTime=reservationTime&adminReason=adminReason";
														//window.location.href=query + encodeURI(adminReason);
